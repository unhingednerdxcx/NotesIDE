...
func upgradePython() {
	cmd := exec.Command("brew", "upgrade", "python")
...
func main() {
	...
	switch {
	case packet_manager_exist("/usr/local/bin/brew"):
		Output(3, "Detected package manager: brew")
		jsonmanager("data/info.json", "w", "os.packageManager", "/usr/local/bin/brew")
		jsonmanager("data/info.json", "w", "os.type", "MacOS")
	case packet_manager_exist("/opt/homebrew/bin/brew"):
		Output(3, "Detected package manager: brew")
		jsonmanager("data/info.json", "w", "os.packageManager", "/opt/homebrew/bin/brew")
		jsonmanager("data/info.json", "w", "os.type", "MacOS")
	default:
		Output(4, "PACKAGE MANAGER NOT FOUND, INSTALL brew")
	}
